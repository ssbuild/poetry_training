...
from fastdatasets.record import load_dataset as Loader, RECORD, WriterObject,NumpyWriter, gfile
...
if __name__ == '__main__':
    ...
    if data_args.do_train:
        dataHelper.make_dataset_with_args(data_args.train_file,mixed_data=False, shuffle=True,mode='train',num_process_worker=10)
