...
from deep_training.nlp.models.LLaMA import LLaMAConfig
...
train_info_args = {
    ...
    'tokenizer_name': './LLaMA_base_config',
    'config_name': './LLaMA_base_config/config.json',
...
if __name__ == '__main__':
    ...
    tokenizer, config, label2id, id2label = dataHelper.load_tokenizer_and_config(config_class_name=LLaMAConfig)
